...
public class ClassMeta<T> {
     ...
     */
    public ClassMeta(Class<T> target, AbstractPersistenceFactory persistenceFactory) throws ClassNotFoundException, IntrospectionException, InstantiationException, IllegalAccessException {
    ...
    private void initializeProxyFactory(final AbstractPersistenceFactory persistenceFactory) throws IllegalAccessException, InstantiationException {
        ...
        proxyMethodHandler = new MethodHandler() {
            public Object invoke(Object self, Method m, Method proceed, Object[] args) throws Throwable {
                ...
                persistenceFactory.loadLazyPropertyIfNecessary(ClassMeta.this, self, proceed, m, args);
